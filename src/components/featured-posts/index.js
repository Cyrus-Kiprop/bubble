  ...
  const [articles] = useState([
    {
      ...
      articleLink:
        'https://medium.com/@cyrus_kiprop/cracking-the-css-display-inline-block-inline-block-none-visibility-hidden-property-851ad5ee926',
      postedOn: '05,12,2019',
      shortDescription:
    ...
    },
    {
      ...
      articleLink:
        'https://www.hackernoon.com/ruby-on-rails-hidden-secrets-how-to-get-the-most-out-of-active-record-associations-6m133w8a',
      postedOn: '13.10.2020',
      shortDescription:
        'I struggled a lot with Rails models as a beginner. I spent a lot of time reading the docs, read a couple of medium articles, watched some youtube videos but all in vain',
                ...
                <div className="mh-blog-item dark-bg wow fadeInUp">
                  ...
                  <div className="blog-inner">
                    ...
                    <div className="d-flex justify-content-start">
                      <a
                        href="https://medium.com/@cyrus_kiprop/cracking-the-css-display-inline-block-inline-block-none-visibility-hidden-property-851ad5ee926"
                        target="_blank"
                      >
                        Read More
                      </a>
